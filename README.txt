...
To Apply custom built or modified Remediation outside of whats included (No Remediation files included on GITHUB, files will only be availible to CIS members) please place the following files:
comp_registry.pol
GptTmpl.inf
user_registry.pol
